...
ROLE_HINTS = {
    "tiktok": (
АНКЕТА ТИКТОКЕРА (Minecraft сервер)

⚠️ Требования:
• Минимум 50 подписчиков
• Минимум 500 просмотров на видео (в среднем)

---

1. Основная информация
• Ник в игре:
• Реальное имя (по желанию):
• Возраст:
• Страна / часовой пояс:
...
• Ник в TikTok:
• Ссылка на профиль:
• Количество подписчиков (не менее 50):
• Среднее количество просмотров (не менее 500):
• Тематика контента (Minecraft / мемы / PvP / выживание и т.д.):

---

❗️ Важно: Если ваш аккаунт не соответствует требованиям, заявка не будет рассмотрена.

---

3. Опыт
• Сколько времени снимаешь TikTok:
• Был ли опыт работы с серверами:
• На каких серверах играл/снимал:

4. Контент-план
• Какие видео планируешь снимать на сервере:
• Как часто готов выкладывать ролики:
• Готов ли участвовать в ивентах/съемках: (да/нет)

5. Техническая часть
• Устройство для записи (ПК / телефон):
• Умеешь ли монтировать видео: (да/нет)
• Какие программы используешь:

6. Дополнительно
• Почему хочешь стать тиктокером нашего сервера:
• Что можешь предложить серверу:
• Есть ли у тебя идеи для продвижения:
